...
function Modal({ isOpen, onClose, onSubmit, formData, setFormData }) {
  ...
  return (
    <div className='flex flex-col bg-custom-tan rounded-lg justify-center items-center'>
      <div className='p-2'>
        <form>
          <div>
            <label className='font-bold'>Blood Sugar: </label>
